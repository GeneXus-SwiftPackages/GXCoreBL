...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta.20230623154354.xcframework.zip",
			checksum: "e1c24f48baa047c8534ddd063ded5a39dad30441794476b656fa2920fb9a66c1"
		)
	]
)