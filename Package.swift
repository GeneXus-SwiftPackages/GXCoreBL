...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta+20230324153906.xcframework.zip",
			checksum: "224cc09e67050faee6e373b0542d5caf85f8540f7c4adcc90ec32599858d7be9"
		)
	]
)