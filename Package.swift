...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta.20230630204809.xcframework.zip",
			checksum: "52b90471cb57808a3aebc8983c097568daa247a673fb84ecdbf3a9cbc010441b"
		)
	]
)