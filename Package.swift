...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta+20230306155445.xcframework.zip",
			checksum: "52e22ea8932e7e22a94f285e378e7e90d397ad366af43a73786f95b6f97a6282"
		)
	]
)