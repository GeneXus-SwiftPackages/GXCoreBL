...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta+20230609175617.xcframework.zip",
			checksum: "38b7e35d142a2db559ca7071ff422bc029dbbdc6f6d51ba21d9b5c4c38625b1e"
		)
	]
)