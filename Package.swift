...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta+20230321182636.xcframework.zip",
			checksum: "0714a3dfca06827190dcf70b37e087f7891a2194729cb9de207c21a932f974b1"
		)
	]
)