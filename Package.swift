...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta+20230525135158.xcframework.zip",
			checksum: "770ed851c9a25f1624a823e7e5b882081de5422d555d7d470203d9c1b1a7d595"
		)
	]
)