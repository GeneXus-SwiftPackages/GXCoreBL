...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta+20230505123704.xcframework.zip",
			checksum: "38867a90d6888f1a7fb72fce728d12039a6552e8a769cc593f6aeafe5800401f"
		)
	]
)