...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta+20230428153652.xcframework.zip",
			checksum: "19837f20dedffb836523fc17b07594a051c2ebcad8d2fcf563bede970341f6b0"
		)
	]
)