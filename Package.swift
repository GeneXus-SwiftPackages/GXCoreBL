...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta+20230515174624.xcframework.zip",
			checksum: "cdfb88d9e9597a21d328221a483176e3387ea1f55a0597db4908d9c36c090012"
		)
	]
)