...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "7193b9757444ef4165adef1cf28181d86baf871eb2476a7243a79037dec48aac"
		)
	]
)