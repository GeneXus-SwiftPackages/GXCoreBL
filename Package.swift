...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta.20230710220444.xcframework.zip",
			checksum: "c85a579abe6b2486cc0550b06dadddb56ee0a0fb2be01afe00e0ffd93e33356c"
		)
	]
)