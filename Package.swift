...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta+20230323132058.xcframework.zip",
			checksum: "e356d0c74af037018dec04ec2414073c67d653e372a14043c6c853ea3dcf1cfb"
		)
	]
)