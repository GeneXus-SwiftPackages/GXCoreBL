...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreBL-1.0.0-beta.20230616185027.xcframework.zip",
			checksum: "8821d203643719cbf6025158d8c793ac27a56dd18f92aa783f940d9276a78dda"
		)
	]
)